function [ Centers, Borders, Base ] = Initiate( r )
...
Base(1,1)= Centers(1,1)+r/2;  % Base 1 Location
Base(1,2)= Centers(1,2)+sqrt(3)*r/2;

Base(2,1)=Centers(1,1)+2*r;
Base(2,2)=Centers(1,2)-2*sqrt(3)*r/2;  % Base2 Location

Base(3,1)=Centers(1,1)-r;
Base(3,2)=Centers(1,2)-2*sqrt(3)*r/2;  % Base3 Location

Base(4,1)=Centers(1,1)-5*r/2;
Base(4,2)=Centers(1,2)+sqrt(3)*r/2;  % Base4 Location

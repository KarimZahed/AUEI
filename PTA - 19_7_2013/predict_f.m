function [ E,MFS,TCA_correction,L_b] = predict_f(PathType,freq,dist,T_perc,h1,ha,heff,h2,R1,R2,environment,theta,theta_eff, AdjToSea, RecOnLand )
...
%[E,Em]=MFS(PathType, eff_dist, T_perc)  %% 8.1.6 , 9 , 19

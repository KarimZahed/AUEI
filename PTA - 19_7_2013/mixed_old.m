function [ Emix ] = mixed_old( path1,dist1,path2,dist2,path3,dist3,path4,dist4,path5,dist5,path6,dist6,path7,dist7,freq,T_perc,h1,h2,dist)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
if dist<=dist1 % we have only one path
    E1=predict_old(path1,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
...
elseif dist<=(dist1+dist2)%this case we are sure we have 2 paths
    ...
    E1=predict_old(path1,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E2=predict_old(path2,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
...
elseif dist<=(dist1+dist2+dist3)
    ...
    E1=predict_old(path1,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E2=predict_old(path2,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E3=predict_old(path3,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    if strcmpi(path1,'land')
        dist_land=dist1;
        dist_sea=0;
        El1=E1;
...
elseif dist<=(dist1+dist2+dist3+dist4)
    ...
    E2=predict_old(path2,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E3=predict_old(path3,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E4=predict_old(path4,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    if strcmpi(path1,'land')
        dist_land=dist1;
        dist_sea=0;
        El1=E1;
...
elseif dist<=(dist1+dist2+dist3+dist4+dist5)
    ...
    E3=predict_old(path3,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E4=predict_old(path4,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E5=predict_old(path4,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    if strcmpi(path1,'land')
        dist_land=dist1;
        dist_sea=0;
        El1=E1;
...
elseif dist<=(dist1+dist2+dist3+dist4+dist5+dist6)
    ...
    E3=predict_old(path3,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E4=predict_old(path4,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E5=predict_old(path5,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E6=predict_old(path6,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    if strcmpi(path1,'land')
        dist_land=dist1;
        dist_sea=0;
        El1=E1;
...
elseif dist<=(dist1+dist2+dist3+dist4+dist5+dist6+dist7)
    ...
    E5=predict_old(path5,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E6=predict_old(path6,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    E7=predict_old(path7,freq,dist,T_perc,h1,h1,h1,h2,h2,0,0,0);
    if strcmpi(path1,'land')
        dist_land=dist1;
        dist_sea=0;
        El1=E1;
